...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    # optimisation
    parser.add_argument('-o', '--optimize', default=None, nargs=3,
                        help=f'Run optimization for the graph or the classification: use "graph", "clf_head", "threshold_optimization", "threshold_experiment" (e.g. --optimize [optimisation_type] [dataset] [gnn_type]')
    ...
    parser.add_argument('--embed_labels', type=str, default=None,
                        help='Create label embeddings (e.g. --embed_labels [dataset]')
