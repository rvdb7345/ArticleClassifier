"""This file is used for creating the processed dataset out of the litcovid dataset. This also includes harmonising it with the Embase dataset.
...
if __name__ == '__main__':
    ...
    data_df.to_csv(cc_path('data/processed/litcovid/litcovid_articles_cleaned_20230529.csv'))
