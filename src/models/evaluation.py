"""This file contains the code for calculating the different multilabel metrics.

Code taken from Paula Sorolla for consistency with the benchmark.
https://github.com/paula-sorolla/multilabel-classification/blob/main/src/Postprocessing.py
"""
